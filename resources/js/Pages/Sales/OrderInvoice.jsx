        ...
        <OrderLayout user={auth.user} header={'Purchases Invoice'}>
            ...
            <div className="h-screen flex flex-col">
                ...
                <div className="flex flex-col md:flex-row w-full">
                    <div className="w-2/5 bg-white p-5 shadow-2xl rounded-lg">
                        {/* product grid */}
                        <div className="grid grid-cols-4 gap-4 max-h-[90%] overflow-y-auto">
                        {/* <div className="w-2/5 bg-white p-5 shadow-2xl rounded-lg max-h-[400px] overflow-y-auto"> */}
                            {
                                products.length > 0 ? (
                                    products.map((item, index) => (
                                        <div key={index} className="border p-2 rounded-lg shadow-md flex flex-col items-center">
                                            <div className="text-center font-semibold">{item.name}</div>
                                            <div className="text-gray-600">${item.sale_price}</div>
                                    ...
                                    <div className="col-span-4 text-center text-gray-600">No items in the cart</div>
                                )
                            }
                        </div>
                    </div>
                    ...
                    <div className="w-3/4 p-6">
                        ...
                        <div className="h-[70%] bg-white shadow-lg p-2 overflow-hidden">
                    ...
                    <div className="w-1/5 bg-white p-5 shadow-2xl rounded-lg">
                        ...
                        <div className="flex items-center justify-between">
                            <h2 className="text-xl font-semibold mb-2 pb-2 border p-2">Items ({cart.length})</h2>
