            ...
            <div className="divide-y divide-gray-200 space-y-5">
                <div>
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center">
                            ...
                            <label htmlFor="cat-1" className="text-gray-600 ml-3 cursor-pointer">Bedroom</label> 444
                ...
                <div className="pt-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="size-selector">
                            <input type="radio" name="size" id="size-md" className="hidden" />
                            <label htmlFor="size-md" className="text-xs border border-gray-200 rounded-sm h-6 w-6 flex items-center justify-center cursor-pointer shadow-sm text-gray-600">M</label>
                        </div>
                        <div className="size-selector">
                            <input type="radio" name="size" id="size-lg" className="hidden" />
                            <label htmlFor="size-lg" className="text-xs border border-gray-200 rounded-sm h-6 w-6 flex items-center justify-center cursor-pointer shadow-sm text-gray-600">L</label>
                        </div>
                        <div className="size-selector">
