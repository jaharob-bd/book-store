                ...
                <div className="flex flex-col md:flex-row w-full h-full">
                    ...
                    <div className="w-1/5 bg-white p-5 shadow-2xl rounded-lg">
                        ...
                        <input
                            ...
                            className="border p-1 w-full mb-3"
                            style={supplier.id ? { backgroundColor: 'green', color: 'white' } : {}}
                            value={supplier.phone ? supplier.name : 'Walking supplier'}
                            onChange={(e) => setSupplier({ ...supplier, name: e.target.value })}
                            readOnly={!!supplier.id}  // Makes the input read-only if customer.id is not null
                        />
